...
import { Page, Button, ButtonContainer, Form, Heading } from './compnents';

UIManager.setLayoutAnimationEnabledExperimental &&
UIManger.setLayoutAnimationEnabledExperimenatal(true);
...
export default class App extends Component<{}, State> {
  auth = new AppAuth({
    issuer: 'https://dev-173356.oktapreview.com/oauth2/default',
    clientId: '{clientId}',
    redirectUrl: 'com.oktapreview.dev-173356:/callback'
  });
